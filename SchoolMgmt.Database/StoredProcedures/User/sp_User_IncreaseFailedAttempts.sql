...
CREATE PROCEDURE `sp_User_IncreaseFailedAttempts` (IN `p_UserId` INT, IN `p_MaxFailed` INT, IN `p_LockoutMinutes` INT, OUT `o_FailedCount` INT, OUT `o_IsLocked` TINYINT(1))   BEGIN
